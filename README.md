...
The figures below mirror the main paper figures so the repository front page shows the full study structure,
data construction logic, model context, and failure analysis path without opening the manuscript first.

<table>
  <tr>
    <td width="58%">
      <img src="artifacts/figures/fig_roadmap_paper.png" alt="Controlled-study roadmap from fixed layouts to robustness diagnoses" width="100%" />
    </td>
    <td width="42%">
      <img src="artifacts/figures/fig_rtdetr_overview.png" alt="RT-DETR architecture overview used in the study" width="100%" />
    </td>
  </tr>
  <tr>
    <td align="center"><strong>Study roadmap</strong></td>
    <td align="center"><strong>Detector context</strong></td>
  </tr>
  <tr>
    <td width="58%">
      <img src="artifacts/figures/fig_4_variations.png" alt="ABCD clean-scan variant construction overview" width="100%" />
    </td>
    <td width="42%">
      <img src="artifacts/figures/fig_roi_extraction.png" alt="ROI extraction and geometry-versus-background isolation overview" width="100%" />
    </td>
  </tr>
  <tr>
    <td align="center"><strong>Paired variant construction</strong></td>
    <td align="center"><strong>ROI isolation workflow</strong></td>
  </tr>
  <tr>
    <td>
      <img src="artifacts/figures/fig_1876_comparison.png" alt="Paired clean and scanned rendering example 1876" width="100%" />
    </td>
    <td>
      <img src="artifacts/figures/fig_5906_comparison.png" alt="Paired clean and scanned rendering example 5906" width="100%" />
    </td>
  </tr>
  <tr>
    <td align="center"><strong>Paired example 1876</strong></td>
    <td align="center"><strong>Paired example 5906</strong></td>
  </tr>
  <tr>
    <td>
      <img src="artifacts/figures/fig_degradation_grid.png" alt="Factorized degradation grid on CAD-derived inputs" width="100%" />
    </td>
    <td>
      <img src="artifacts/figures/fig_degradation_ladder.png" alt="Qualitative degradation ladder from tight to loose to missed detections" width="100%" />
    </td>
  </tr>
  <tr>
    <td align="center"><strong>Controlled degradations</strong></td>
    <td align="center"><strong>Failure progression</strong></td>
  </tr>
</table>
